...
import tasks.basics.implicits.SuperVipCollections4s._
import tasks.basics.implicits.SuperVipCollections4s.syntax._
import tasks.basics.ImplicitsHomeworkSpec.TestValue
...
class implicitsSpec extends AnyFreeSpec with Matchers {
  ...
  "Iterate2 instances provided" - {
    "for Map" in {
      assertCompiles(
        """import tasks.basics.implicits.SuperVipCollections4s._
          |import tasks.basics.implicits.SuperVipCollections4s.instances._
          |
  ...
  "TwitCache" - {
    import tasks.basics.implicits.MyTwitter._
